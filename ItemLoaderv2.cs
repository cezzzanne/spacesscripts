...
namespace Spaces {
    public class ItemLoaderv2 : MonoBehaviour {
    ...
    //     public void AddPurchasedItem(StoreItem item) {
    ...
    //         }
    //         inEditing = !inEditing;
    //         uiManagerScript.ToggleEditing(true);
    //     }

    //     public void SetCamera(PlayerFollow cam) {
    //         mainCam = cam;
    //         PhotoManager.GetComponent<PhotoManagerPublicScript>().SetMainCam(cam);
    //         ItemLoaderStore.GetComponent<ItemLoaderStore>().SetMainCam(cam);
    ...
    //         itemController.GetComponent<ItemPlacementControllerV2>().HandleNewObj(itemName);
    //     }

    //     public void CancelEditing() {
    //         inEditing = false;
    //         NoItemsBanner.SetActive(false);
    //         uiManagerScript.ToggleEditing(false);
    //         mainCam.ToggleItemSelect();
    //     }
